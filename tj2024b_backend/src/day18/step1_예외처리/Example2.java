...
//			NullPointerException : 
		try {
			...
			String str2 = null;
			System.out.println( str2.length() ); // 예외발생
...
//			InputMismatchException
		try {
			...
			int value3 = scan.nextInt(); // 만약에 int타입 허용할 수 없는 입력이면 예외발생
...
//			Exception
		...
		catch( Exception e ) { System.out.println( e ); } // 만약에 다중 catch에서 부모크래스인 Exception 사용할 경우는 마지막에 catch
