...
//		[1] 일반 예외 : 컴파일러 예외처리 검사 , 자동으로 예외처리하라고 경고가 뜸.
			// Class.forName("패키지경로.클래스명") : 지정한 클래스
		try {
//			만약에 예외가 발생하거나 발생할것 같은 코드
			Class.forName("java.lang.String"); 	// String 클래스가 존재하므로 예외 발생 하지 않	
